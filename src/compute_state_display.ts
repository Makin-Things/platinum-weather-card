...
export const entityComputeStateDisplay = (localize: LocalizeFunc, stateObj: HassEntity, locale: FrontendLocaleData): string | undefined => {
  ...
  return (
    ...
    (stateObj.attributes.device_class && localize(`component.${domain}.entity_component.${stateObj.attributes.device_class}.state.${stateObj.state}`)) ||
...
export const stringComputeStateDisplay = (localize: LocalizeFunc, stringObj: string): string | undefined => {
  return (
    // Return default translation
